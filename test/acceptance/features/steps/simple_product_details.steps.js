...
Then('shopper is able to see all the information related to a Simple Product', async () => {
    ...
    (await I.grabTextFrom(productPage.locators.productDetails)).should.equal('1682 ballistic nylon and genuine leather inserts |Pull-out metallic handle for wheeling|Top and side handles|Cabin size for convenient travelling|TSA lock for security'); // Product Details
