 ...
 * @param {Object} options - to configure the product object
 *
...
module.exports = function productTile(product, apiProduct, productType, options) {
    ...
    // decorators.searchPrice(product, productSearchHit, promotionCache.promotions, getProductSearchHit); // TODO remove line
